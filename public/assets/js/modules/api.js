...
const api_token = 'fcd22cb1ede14d98a7a39a0b056ffbde'
                                ...
                                <div class="col s12 z-depth-2">
                                    ...
                                    <div class="card-content row valign-wrapper">
                                        <div class="col s4" class="logo-team">
                                            <img src="${urlTeamImage}" alt="${team.name}" class="responsive-img center-align" width="70%" >
                                        </div>
                                    ...
                                    <div class="card-action right-align">
                                        ...
                                        <button onclick="addFavouriteTeam(${team.id},'${urlTeamImage}','${team.name}','${team.venue}','${team.clubColors}','${team.website}')" class="waves-effect waves-light btn orange accent-3">FAVOURITE</button>
                                    </div>
                                    </div>
                                </div>
                                `
